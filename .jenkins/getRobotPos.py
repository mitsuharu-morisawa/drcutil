...
rg = rtm.findRTC("rg")
rg_svc = rtm.narrow(rg.service("service0"), "RobotGatewayService")
klass = getClassNameOfData(rg.port("event"))

conprof = connectWithDataPort(rg.port("event"))
rg_svc.getRobotState()
