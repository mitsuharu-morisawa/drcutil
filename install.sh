...
if [ "$INTERNAL_MACHINE" -eq 0 ]; then
    ...
    cmake_install_with_option "hmc2" "-DCOMPILE_JAVA_STUFF=OFF -DGENERATE_FILES_FOR_SIMULATION=OFF"
    cmake_install_with_option "hrpsys-humanoid" "-DCOMPILE_JAVA_STUFF=OFF -DGENERATE_FILES_FOR_SIMULATION=OFF"
fi
