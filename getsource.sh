...
then
    ...
    git clone ssh://atom.a01.aist.go.jp/git/HRP2JVRC.git
fi
...
git clone https://github.com/jvrc/JVRCPlugin.git
GIT_SSL_NO_VERIFY=1 git clone https://choreonoid.org/git/jvrc-hrg.git
cd ../..
